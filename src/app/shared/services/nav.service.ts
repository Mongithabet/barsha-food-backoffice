	...
	constructor(private router: Router) {
		...
		if (admin != null) this.MENUITEMS =
			[
				...
				{ path: '/dashboard/default', title: 'لوحة العدادات', icon: 'home', type: 'link', bookmark: true },
 ...
 */
                        { path: '/v1/admin/deliverymans', title: 'رجال التسليم', type: 'link' },


						/* 						{ path: '/v1/admin/user-management/delivery-company-management', title: 'شركات التسليم', type: 'link' },
 */
                        { path: '/v1/admin/deliverycompanies', title: 'شركات التسليم', type: 'link' },
				...
				{
					title: 'إعدادات المنصة', icon: 'settings', type: 'sub', active: false, children: [
						{ path: '/v1/admin/delivery-type-management', title: 'طرق التوصيل', type: 'link' },
						{ path: '/v1/admin/order-type-management', title: 'أنواع الطلبات', type: 'link' },
						{ path: '/v1/admin/platform-setting-management', title: 'الاعدادات العامة', type: 'link' },
					]
				},
