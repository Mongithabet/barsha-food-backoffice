...
import { SpecialityManagementRoutingModule } from './speciality-management-routing.module';
...
@NgModule({
  declarations: [
    ...
    CreateUpdateSpecialityComponent
  ],
  imports: [
    CommonModule,
    SpecialityManagementRoutingModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
    ReactiveFormsModule,
...
export class SpecialityManagementModule { }
